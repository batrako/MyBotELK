...
;Milking
	...
	IniWrite($config, "attack", "HysterGobs", GUICtrlRead($txtchkHysterGobs))
	IniWrite($config, "attack", "TempoTrain", GUICtrlRead($txtchkTempoTrain))
...
;Noyax bottom
	...
	IniWrite($config, "pushbullet", "AccountToken2", GUICtrlRead($PushBTokenValue2)) ; noyax telegram
