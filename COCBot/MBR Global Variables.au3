...
Global $LightningSpellComp = 0, $HealSpellComp = 0, $RageSpellComp = 0, $PoisonSpellComp = 0, $HasteSpellComp = 0,$EarthSpellComp = 0
...
Global $TempoTrain = 15
Global $NbPixelmaxExposed = 40
Global $DBUseGobsForCollector = 6
Global $txtDBUseGobsForCollector
